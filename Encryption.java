    ...
    public class Encryption {
        ...
        public static void main(String[] args){
            ...
            System.out.println("Enter first phrase to be encrypted. Press enter to enter next phrase. Type '1' when complete.");
            String word = s.nextLine();
            while (!word.equals("1")){
                messages.add(word.toLowerCase());
                System.out.println("Enter next phrase to be encrypted. Press enter to enter next phrase. Type '1' when complete.");
                word = s.nextLine();
            }
